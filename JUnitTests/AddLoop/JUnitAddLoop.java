...
public class JUnitAddLoop {
	...
	public void test9() {
		AddLoop a = new AddLoop();
		assertEquals(1718512746, a.AddLoop(809056311, 909456435));
	}

	@Test
	public void test10() {
		AddLoop a = new AddLoop();
		assertEquals(-1330117119, a.AddLoop(-1330117119, 0));
	}

	@Test
	public void tes11() {
		AddLoop a = new AddLoop();
		assertEquals(509797374, a.AddLoop(627270655, -117473281));
	}

	@Test
	public void test12() {
		AddLoop a = new AddLoop();
		assertEquals(1269086356, a.AddLoop(726683691, 542402665));
	}
	...
	public void tes14() {
		AddLoop a = new AddLoop();
		assertEquals(711446632, a.AddLoop(721441023, -9994391));
	}
}
